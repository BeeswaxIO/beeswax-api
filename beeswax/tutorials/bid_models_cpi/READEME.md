...
* In (Part 1)[https://part.one], we discuss ingesting and preparing log data and then generate our CPI model using SageMaker
* In (Part 2)[https://part.two], we create a set of prediction files from our CPI model and then upload to Beeswax 
